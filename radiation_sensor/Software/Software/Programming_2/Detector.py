...
def Kromek_Acquisition_Start(detectorID, liveTime_sec, realTime_sec):
    """
    ...
    ***********************************************************************************************
    ...
    if __name__ == '__main__':
        ...
        while nextDetectorID:
            ...
            Kromek_Acquisition_Start(thisDetectorID, liveTime_sec=diagnostics_LiveTime_sec,realTime_sec = diagnostics_LiveTime_sec)
...
timeup = int(input('Enter Live-Time for Detector in Minutes:     '))
trial = 'Test_Runs/'+input('Enter File Name for Raw Data (No Extension):     ')

# The following line runs the Python detection program
runDetect(timeup,trial)
